...
interface AddToCartAction extends Action<"ADD_TO_CART"> {
  payload: {
    item: Omit<CartItem, "quantity">; // to omit/remove from the item: Omit<Item, 'field1ToOmit' | 'field2ToOmit'|...>
  };
}
...
const AppStateProvider: React.FC = ({ children }) => {
  // const [state, setState] = useState<AppStateValue>(); // if we need the state to be undefined
  ...
  // save the cart in local storage, need to invoke after the initialize cart
  useEffect(() => {
